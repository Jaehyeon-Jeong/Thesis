...
| `stage4_film_conditioning` | Market-context concat/gating/FiLM | In progress; v1/v2 diagnostics show simple context injection is not yet robust; V7 bounded/residual last-block FiLM is prepared for Kaggle | [README](stage4_film_conditioning/README.md), [checklist](stage4_film_conditioning/checklist.md) |
...
| `stage4_film_conditioning` | Market-context concat/gating/FiLM | 진행 중; 단순 context injection은 아직 robust하지 않음; V7 bounded/residual last-block FiLM Kaggle 실행 준비 완료 | [README](stage4_film_conditioning/README.md), [checklist](stage4_film_conditioning/checklist.md) |
