...
flowchart TD
    ...
    D --> E[Stage 4<br/>FiLM + News/LLM conditioning]
    ...
    E --> E1[Gamma-only FiLM<br/>Full FiLM<br/>News/LLM conditioning<br/>gamma/beta interpretation]
```
...
flowchart TD
    ...
    E --> E1[Gamma-only FiLM<br/>Full FiLM<br/>News/LLM conditioning<br/>gamma/beta 해석]
```
