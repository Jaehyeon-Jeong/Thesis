...
| `4-N13-0/1` | Macro/RORO source audit + OFR FSI feature builder | Completed; OFR FSI context artifact built with six train-normalized risk-off proxy features | [N13-1 result](checklist_results/4-N13-1_ofr_fsi_feature_builder.md), [audit](reports/tables/stage4_fsi_context_i60_ohlc_ma_vb_r20_ofr_fsi_lag1_w20_60_seed42_fsi_context_feature_audit.json) |
