...
| `4-N12-C` | Stage 2 checkpoint loaded/frozen + technical-only bounded FiLM | Runner prepared; separates image-derived technical context from external/news context under the frozen Stage 2 protocol | [N12-C prep](checklist_results/4-N12-C_technical_only_pretrained_frozen_bounded_film.md) |
