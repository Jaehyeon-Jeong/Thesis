...
| `4-N13-2` | FSI-only frozen bounded FiLM | Prepared for Kaggle; tests `fsi_2`, `fsi_3`, and `fsi_all` under the frozen Stage 2 protocol | [N13-2 notebook](notebooks/kaggle_stage4_n13_2_fsi_only_pretrained_frozen_bounded_film_one_cell.md), [screening](checklist_results/4-N13-1_fsi_feature_screening.md) |
