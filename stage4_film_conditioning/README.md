...
| `4-N13-3/4` | KC Fed-inspired public-data RORO proxy + FiLM | N13-3 builder prepared; KC Fed official RORO files are cached but start in June 2023, so N13-4 needs the longer-history public proxy artifact before training | [N13-3 builder](checklist_results/4-N13-3_public_roro_proxy_builder.md), [Kaggle cell](notebooks/kaggle_stage4_n13_3_public_roro_context_features_one_cell.md) |
