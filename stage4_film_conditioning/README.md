...
| `4-N13-0/1` | Macro/RORO source audit + OFR FSI feature builder | Prepared; OFR FSI builder, Kaggle one-cell, and local upload zip are ready; actual artifact build pending on Kaggle | [N13-1 prep](checklist_results/4-N13-1_ofr_fsi_feature_builder.md), [N12/N13 plan](checklist_results/4-N12_gated_film_and_context_source_plan.md) |
