...
| `4-N13-5/5A/5B/6` | Macro comparison, cross-context feature audit, selected-combo FiLM, interpretability export | Planned; first compare FSI/RORO/F&G/news/technical, then run train-only corr/redundancy audit for a small selected-combo context if justified, then export targeted Grad-CAM plus gamma/beta summaries | [N12/N13 plan](checklist_results/4-N12_gated_film_and_context_source_plan.md) |
