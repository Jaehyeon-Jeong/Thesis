...
| `4-N13-5/5A/5B/6` | Macro comparison, cross-context feature audit, selected-combo FiLM, interpretability export | N13-5 completed; F&G-only s0.02 remains the best compact accuracy candidate, news SVD32 s0.02 remains the best interpretability/calibration candidate, and FSI/RORO are stable but weak alone; proceed to train-only cross-context feature audit before selected-combo FiLM | [N13-5 result](checklist_results/4-N13-5_macro_context_source_comparison.md), [compact table](reports/tables/stage4_n13_5_context_source_comparison_compact.csv), [N12/N13 plan](checklist_results/4-N12_gated_film_and_context_source_plan.md) |
