...
| `4-N13-5/5A/5B/6` | Macro comparison, cross-context feature audit, selected-combo FiLM, interpretability export | N13-5A completed on 2,399 aligned rows and 126 features; N13-5B selected six-feature combo completed and tied Stage 2 accuracy (`0.5793`) with net correction `0`, so it is a neutral ablation rather than a final candidate | [N13-5 result](checklist_results/4-N13-5_macro_context_source_comparison.md), [N13-5A audit](checklist_results/4-N13-5A_cross_context_feature_audit.md), [N13-5B result](checklist_results/4-N13-5B_selected_combo_context_film.md), [Kaggle cell](notebooks/kaggle_stage4_n13_5b_selected_combo_pretrained_frozen_bounded_film_one_cell.md) |
