...
| `4-N13-3/4` | KC Fed-inspired public-data RORO proxy + FiLM | N13-3 artifact built locally from cached VIX, S&P500, and US 10Y sources; train-only PCA formula documented; `context_dim=9`, explained variance ratio `0.7201`, no missing warnings; N13-4 five-seed FiLM run is next | [N13-3 builder](checklist_results/4-N13-3_public_roro_proxy_builder.md), [audit](reports/tables/stage4_roro_context_i60_ohlc_ma_vb_r20_public_roro_pca_lag1_w20_60_seed42_roro_context_feature_audit.json), [Kaggle cell](notebooks/kaggle_stage4_n13_3_public_roro_context_features_one_cell.md) |
