# Kaggle Stage 4 N10 Selected News Interpretability One Cell
...
This runner exports selected Grad-CAM/modulation artifacts for the best N9
...
- The N9 grid selected SVD32/scale0.02 as the best accuracy candidate.
- This N10 cell fills the missing Grad-CAM/context/gamma/beta artifacts for
...
N9_GRID_LABEL = "n10_news_interpretability_svd32_s0p02"
...
# Smoke check only. For the real N10 export, keep False.
SMOKE_TEST = False
...
# ============================================================
# 3. Train/evaluate/export selected news-conditioned bounded FiLM artifacts
# ============================================================
smoke_train_args = []
smoke_data_args = []
if SMOKE_TEST:
...
for svd_dim in SVD_DIMS:
    ...
    for scale in MODULATION_SCALES:
        ...
        for run_seed in RUN_SEEDS:
            ...
            try:
                if minimal_completed(svd_dim, scale, run_seed):
                    print(
                        f"[metric-ready] Reusing existing checkpoint/prediction/metric output for {exp}, seed={run_seed}",
                        flush=True,
                    )
                else:
                    run([
...
display(Markdown("# Stage 4 N10 Selected News Interpretability Seed-Level Results"))
display(seed_df.sort_values(["svd_dim", "modulation_scale", "run_seed"]))

display(Markdown("# Stage 4 N10 Selected News Interpretability Mean/Std Summary"))
...
display(pd.DataFrame([
    {
        ...
        "roc_auc_mean": 0.5857,
        "note": "Completed anchor for news-FiLM interpretation.",
    },
    {
    ...
    },
    {
        ...
        "roc_auc_mean": 0.5849,
        "note": "Target visual baseline before N9/N10.",
    },
]))
