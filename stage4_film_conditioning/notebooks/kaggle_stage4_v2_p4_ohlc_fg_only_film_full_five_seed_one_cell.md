# Kaggle Stage 4 v2 Priority 4 OHLC F&G-Only FiLM-Full Five-Seed One Cell
...
This runner executes Stage 4 v2 priority 4:
...
# Smoke check only. For the real 4-V3 run, keep False.
SMOKE_TEST = False
...
seed_csv = tables_root / "stage4_v2_p4_ohlc_fg_only_film_full_five_seed_seed_results.csv"
mean_std_csv = tables_root / "stage4_v2_p4_ohlc_fg_only_film_full_five_seed_mean_std_results.csv"
run_summary_json = tables_root / "stage4_v2_p4_ohlc_fg_only_film_full_five_seed_run_summary.json"
...
backup_outputs("stage4_v2_p4_ohlc_fg_only_film_full_five_seed", "after_summary", context_method=None, run_seed=None)

display(Markdown("# Stage 4 v2 Priority 4 OHLC F&G-Only FiLM-Full Five-Seed Seed-Level Results"))
display(seed_df.sort_values(["context_method", "run_seed"]))

display(Markdown("# Stage 4 v2 Priority 4 OHLC F&G-Only FiLM-Full Five-Seed Mean/Std Summary"))
if not mean_std_df.empty and "accuracy_mean" in mean_std_df.columns:
